...
def build_pdf():
    ...
    story.extend(
        [
            ...
            Paragraph("Stand der Integration in Version 0.7.0", styles["H1MC"]),
            Paragraph(
    ...
    story.extend(
        [
            ...
            Paragraph(
                ...
                "  labels:<br/>"
                "    com.hypetek.mission-control.deployment: \"0.7.0\"<br/>"
                "  environment:<br/>"
                ...
                "    LT_LOAD_ONLY: en,de,ru,it,fr,es,pt,pl,nl,tr,ar<br/>"
                "  volumes:<br/>"
            ...
            Paragraph(
                "Die Antwort muss unter anderem version 0.7.0, agent_api 3 und "
            ...
            Paragraph(
                "Standardmäßig werden en,de,ru,it,fr,es,pt,pl,nl,tr,ar als verwaltetes Sprachpaket geladen. Die Erkennung "
