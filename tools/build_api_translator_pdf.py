...
def build_pdf():
    ...
    story.extend(
        [
            ...
            Paragraph("Was ist ab Version 0.5.1 neu?", styles["H1MC"]),
            Paragraph(
    ...
    story.extend(
        [
            ...
            Paragraph(
                ...
                "  labels:<br/>"
                "    com.hypetek.mission-control.deployment: \"0.5.1\"<br/>"
                "  environment:<br/>"
            ...
            Paragraph(
                "Die Antwort muss unter anderem version 0.5.1, agent_api 3 und "
