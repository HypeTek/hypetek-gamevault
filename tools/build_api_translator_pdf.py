...
def build_pdf():
    ...
    story.extend(
        [
            ...
            Paragraph("Stand der Integration in Version 0.8.1", styles["H1MC"]),
            Paragraph(
    ...
    story.extend(
        [
            ...
            Paragraph(
                ...
                "  labels:<br/>"
                "    com.hypetek.mission-control.deployment: \"0.8.1\"<br/>"
                "  environment:<br/>"
            ...
            Paragraph(
                "Die Antwort muss unter anderem version 0.8.1, agent_api 3 und "
