...
def build_pdf():
    ...
    story.extend(
        [
            ...
            Paragraph("Stand der Integration in Version 0.9.0-rc.4", styles["H1MC"]),
            Paragraph(
    ...
    story.extend(
        [
            ...
            Paragraph(
                "gamevault:<br/>"
                "  image: ghcr.io/hypetek/hypetek-gamevault:0.9.0-rc.4<br/>"
                "  pull_policy: always<br/>"
                "  labels:<br/>"
                "    com.hypetek.mission-control.deployment: \"0.9.0-rc.4\"<br/>"
                "  environment:<br/>"
                ...
                "    LT_LOAD_ONLY: en,de,ru,it,fr,es,pt,pl,nl,tr,ar,zh<br/>"
                "  volumes:<br/>"
            ...
            Paragraph(
                "Die Antwort muss unter anderem version 0.9.0-rc.4, agent_api 3 und "
