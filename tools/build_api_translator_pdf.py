...
def build_pdf():
    ...
    story.extend(
        [
            ...
            Paragraph("Stand der Integration in Version 0.9.0-rc.5", styles["H1MC"]),
            Paragraph(
    ...
    story.extend(
        [
            ...
            Paragraph(
                "gamevault:<br/>"
                "  image: ghcr.io/hypetek/hypetek-gamevault:0.9.0-rc.5<br/>"
                "  pull_policy: always<br/>"
                "  labels:<br/>"
                "    com.hypetek.mission-control.deployment: \"0.9.0-rc.5\"<br/>"
                "  environment:<br/>"
            ...
            Paragraph(
                "Die Antwort muss unter anderem version 0.9.0-rc.5, agent_api 3 und "
