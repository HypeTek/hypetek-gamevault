...
begin
  ...
  try
    ...
    Request.Open('GET', ValidationUrl, False);
    ...
    if (StatusCode = 204) and (ValidationHeader = 'authenticated') then
      ...
      MsgBox(
        'Der Agent-Token stimmt nicht mit GAMEVAULT_AGENT_TOKEN auf dem Server überein.' +
        #13#10 + #13#10 + 'Es wurde noch nichts gespeichert.',
        mbError,
        MB_OK)
    else
      MsgBox(
