...
class AppTests(unittest.TestCase):
    ...
    def test_health_reports_running_version_and_agent_api(self):
        ...
        self.assertEqual(health["version"], "0.3.18")
    ...
    def test_windows_agent_download(self):
        ...
        self.assertEqual(
            ...
            "https://github.com/HypeTek/hypetek-gamevault/releases/download/v0.3.18/HypeTek-Mission-Control-Agent-Setup.exe",
        )
    ...
    def test_appearance_settings_and_scan_exclusions(self):
        ...
        self.assertIn("/static/app.js?v=0.3.18", html)
        self.assertIn("/static/i18n.js?v=0.3.18", html)
        self.assertIn("/static/app.css?v=0.3.18", html)
        ...
        self.assertEqual(settings["version"], "0.3.18")
