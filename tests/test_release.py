...
class ReleaseMetadataTests(unittest.TestCase):
    def test_release_versions_are_consistent(self):
        ...
        self.assertIn('"info.overview": "Опис гри"', translations)
        ...
        self.assertIn("LT_LOAD_ONLY: en,de,ru,it,fr,es,pt,pl,nl,tr,uk", compose)
        self.assertIn('com.hypetek.mission-control.deployment: "0.3.18"', compose)
