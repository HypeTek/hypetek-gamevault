...
1. Confirm `ghcr.io/hypetek/hypetek-gamevault:0.9.0-rc.1` exists and passes its `/health` check.
...
This package intentionally uses catalog package version `1.0.0` for a new app while `app_version` tracks the upstream Mission Control container version `0.9.0-rc.1`.
